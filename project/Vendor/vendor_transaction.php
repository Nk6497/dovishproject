...
$sql = "SELECT * FROM transactions WHERE status = 1 and vendor_id = '$vendor_id'";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Vendor/css/vendor_transaction.css"> 
</head>   
<body>   
    <?php
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $sql_user = "SELECT name FROM customers WHERE id = '{$row['customer_id']}'";
