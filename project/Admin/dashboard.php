        ...
        <div class="dashboard-container">
            <ul>   
                <?php if ($_SESSION['role'] == 'admins') { ?>      
                    ...
                    <li><a href="#" onclick="loadPage('customer_add.php')">Customers</a></li>
                ...
                <?php } if ($_SESSION['role'] == 'customers') { ?>
                    ...
                    <li><a href="#" onclick="loadPage('vendor_list.php')">Vendor List</a></li>
                    <li><a href="#" onclick="loadPage('../Customer/use_limit.php')">Use Limit</a></li>
                    <li><a href="#" onclick="loadPage('../Customer/wallet_balance.php')">Wallet balance</a></li>
                    <li><a href="../logout.php">Logout</a></li>
